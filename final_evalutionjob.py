...
df = pd.read_excel('/home/mohan/data/job_up.xlsx',sheetname=0) # reading the data through pandas csv frame
#data = df.iloc[:,1:3]
...
for i in range(len(train_data)):
    if(train_data[i,1]=='JOB'):                 #change the label appropriately according to the event chosen for the training data
        train_data[i,1] = 1
...
input_data_matrix = open('/home/mohan/Downloads/Theano-Tutorials-master/fitted_matrix_JOB.pkl', 'wb')
...
output1 = open('/home/mohan/Downloads/Theano-Tutorials-master/clf1_JOB.pkl', 'wb')
...
output2 = open('/home/mohan/Downloads/Theano-Tutorials-master/clf2_JOB.pkl', 'wb')
...
output3 = open('/home/mohan/Downloads/Theano-Tutorials-master/clf3_JOB.pkl', 'wb')
