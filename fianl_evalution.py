...
df = pd.read_excel('/home/mohan/data/acq_up.xlsx',sheetname=0)
#data = df.iloc[:,1:3]
...
###########################################################################################################################################
input_data_matrix = open('/home/mohan/Downloads/Theano-Tutorials-master/fitted_matrix_ACQ.pkl', 'wb')
...
output1 = open('/home/mohan/Downloads/Theano-Tutorials-master/clf1_ACQ.pkl', 'wb')
...
output2 = open('/home/mohan/Downloads/Theano-Tutorials-master/clf2_ACQ.pkl', 'wb')
...
output3 = open('/home/mohan/Downloads/Theano-Tutorials-master/clf3_ACQ.pkl', 'wb')
